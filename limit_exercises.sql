...
# Using limit and offset, you're creating a 'pseudo' page number. It's easier to explain with an example - an offset of 50 STARTS the output @ row 51 (kinda like a margin or padding bumping something over, offset bumps the start over). Limit dictates the number of results, and you calculate 'pages' by offset / limit + 1
